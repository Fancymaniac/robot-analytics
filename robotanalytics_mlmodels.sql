...
--
-- Table structure for table `mlmodels`
--
...
--
-- Dumping data for table `mlmodels`
--

LOCK TABLES `mlmodels` WRITE;
/*!40000 ALTER TABLE `mlmodels` DISABLE KEYS */;
/*!40000 ALTER TABLE `mlmodels` ENABLE KEYS */;
UNLOCK TABLES;
